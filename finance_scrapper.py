...
def main():
    ...
    for symbol in symbols_list:
        ...
        #parse html and create a beautiful soup objecta
        ...
        for cell in soup.find_all('td'):
            #odd iterations are keys. Set key on odd numberd iterations
            if counter % 2  != 0:
                key = cell.text
            else:
    ...
    #append stock dictionary to the list of dictionaries
        ...
        #when web crawling its important to make sure it doesnt look like you are trying to do a cyber attack
        #time.sleep(2)
