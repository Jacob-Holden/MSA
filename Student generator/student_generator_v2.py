...
Output: list student dictionaries
"""

# the () in the function would be an input (not the answering kind)
def student_to_dictionary(list_of_students):
    #create a list to store the dictionaries
    # this will be a LIST of several dictionaries
    student_dictioary_list = []
    ...
    for student in list_of_students:
        ...
        #append to student dictionary_list
        student_dictioary_list.append(student_dictionary)

    return student_dictioary_list
